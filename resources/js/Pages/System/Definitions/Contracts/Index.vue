<template>
    <div class="h-full">
        <app-head title="Service Contracts" />
        <Navigation />
        <!--datatable Heading-->
        <div class="app-container py-3">
            <div class="px-4 py-3 bg-white border border-gray-200 flex items-center justify-between">
                <div class="flex items-center">
                    ...
                    <span class="text-lg text-[#1a8f36]">Service Contracts</span>
                </div>
                    ...
                    <template v-slot:datatable-body>
                        ...
                        <tr v-for="record in records.data" :key="record.id">
                            ...
                            <td class="flex items-center justify-center">
                                <Link :href="route('system.definitions.contracts.show', record.id)" as="button" type="button">
