        ...
        <div class="app-container py-3">
            <div class="px-4 py-3 bg-white border border-gray-200 flex items-center justify-between">
                <div class="flex items-center">
                    ...
                    <span class="text-lg text-[#1a8f36]">Service Spots</span>
                </div>
                <div class="search ml-auto">
                    <search-input v-model="params.search"/>
                </div>
                <div class="create ml-4">
                    <Link :href="route('system.definitions.spots.service-spots.create')" as="button" type="button" class="btn-primary flex items-center">
...
export default {
    ...
    data() {
        ...
        let columns = [
            ...
            { name: 'name', label: 'Service Spot Name', width: '20%' },
            { name: 'spot_type_id', label: 'Type', width: '15%' },
            { name: 'area', label: 'Area', width: '15%' },
            { name: 'district', label: 'District', width: '15%' },
