<template>
    <div class="h-full">
        <app-head title="Service Spot Types" />
        <Navigation />
        <ServiceSpotsNav />
        <!--datatable Heading-->
        <div class="app-container py-3">
            <div class="px-4 py-3 bg-white border border-gray-200 flex items-center justify-between">
                <div class="flex items-center">
                    ...
                    <span class="text-lg text-[#1a8f36]">Service Spot Types</span>
                </div>
                <div class="search ml-auto">
                    <search-input v-model="params.search"/>
                </div>
                <div class="create ml-4">
                    <Link :href="route('system.definitions.spots.service-spot-type.create')" as="button" type="button" class="btn-primary flex items-center">
                    ...
                    <template v-slot:datatable-body>
                        ...
                        <tr v-for="record in records.data" :key="record.id">
                            ...
                            <td class="flex items-center justify-center">
                                <Link :href="route('system.definitions.spots.service-spot-type.show', record.id)" as="button" type="button">
...
export default {
    ...
    data() {
        ...
        let columns = [
            ...
            { name: 'name', label: 'Service Spot Type', width: '20%' },
