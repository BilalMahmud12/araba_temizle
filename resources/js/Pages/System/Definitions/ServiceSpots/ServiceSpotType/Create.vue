<template>
    <div class="h-full">
        <app-head title="Add Service Spot Type" />
        <Navigation />
        <ServiceSpotsNav />
        <div class="app-container py-3">
            <div class="px-4 py-3 bg-white border border-gray-200 flex items-center justify-between">
                <div class="flex items-center">
                    ...
                    <span class="text-lg text-[#1a8f36]">New Service Spot Type</span>
                </div>
...
export default {
    ...
    setup() {
        ...
        function submit() {
            form.post(route('system.definitions.spots.service-spot-type.store'), form)
        }
